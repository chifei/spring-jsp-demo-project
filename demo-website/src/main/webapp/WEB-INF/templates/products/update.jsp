...
<html lang="${lang}">
<head>
    <title>Update Product - Spring JSP Demo</title>
...
<div class="container">
    ...
    <h1 id="exampleTitle">
        <strong><spring:message code="product.updateProduct"/></strong>
    </h1>
            ...
            <form>
                ...
                <ul class="fieldlist">
                    <li>
                        ...
                        <input id="name" name="name" type="text" required class="k-textbox" value="${product.name}" style="width: 100%;"/>
                    </li>
                    <li>
                        <label for="description"><spring:message code="product.description"/></label>
                        <textarea id="description" name="description" required class="k-textbox" style="width: 100%;">${product.description}</textarea>
                    </li>
                </ul>
            </form>
        </div>
