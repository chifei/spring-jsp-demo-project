...
<html lang="${lang}">
<head>
    <title><spring:message code="user.userGroupCreate"/> - Spring JSP demo</title>
...
<div class="container">
    ...
    <h1 id="exampleTitle">
        <strong><spring:message code="user.userGroupCreate"/></strong>
    </h1>
...
<script type="text/javascript" src="/static/js/role-create.js"></script>
</body>
</html>