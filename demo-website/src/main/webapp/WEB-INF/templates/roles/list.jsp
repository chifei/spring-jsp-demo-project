...
<html lang="${lang}">
<head>
    <title><spring:message code="user.role"/> - Spring JSP demo</title>
...
<div class="container">
    ...
    <j:hasPermission permission="user.write">
        <div class="themechooser" data-role="details">
            <a href="/admin/user/role/create" class="k-link k-button k-primary tc-activator"><spring:message code="user.userGroupCreate"/></a>
        </div>
    </j:hasPermission>>
    <h1 id="exampleTitle">
        <strong><spring:message code="user.role"/></strong>
    </h1>
